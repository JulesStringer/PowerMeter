...
#if defined(MPFS_USE_EEPROM) || defined(MPFS_USE_SPI_FLASH) || defined(STACK_USE_MPFS2) || defined(MPFS_RAM_ONLY)
#define USE_MPFS 0
#endif
// =======================================================================
...
#define MY_DEFAULT_MAC_BYTE1            (0xA4)/*(0xA3)*/	// Use the default of 00-04-A3-00-00-00
// To get through switch low order 2 bits of first byte of MAC Address must be 0
...
#define MY_DEFAULT_MAC_BYTE6            (MY_IP_LAST)

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (1ul)
//#define MY_DEFAULT_IP_ADDR_BYTE4        (29ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (MY_IP_LAST)
...
//#if defined(STACK_USE_TCP) && !defined(__TCP_C) && defined(USE_ETHERNET)
//#define __TCP_C
//#endif
#define STACK_USE_UDP
#if !defined(STACK_USE_HTTP_SERVER) && !defined(STACK_USE_TELNET_SERVER)
#define NO_TCP_FIND
#endif
 ...
 */
    ...
    //#define TCP_ETH_RAM_SIZE                    (1024ul)
